...
typedef void (_layer_create_func)(mg_arena* arena, layer* out, layer_desc* desc);
...
void _layer_dense_create(mg_arena* arena, layer* out, layer_desc* desc);
void _layer_activation_create(mg_arena* arena, layer* out, layer_desc* desc);
